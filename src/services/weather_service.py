...
class WeatherService:
    ...
    def get_weather_summary(self, destination: str, start_date: str, end_date: str) -> str | None:
        """
    ...
    def _fetch_current_weather(self, destination: str) -> dict[str, Any] | None:
        ...
        try:
            ...
            params = {"q": destination, "appid": self.api_key, "units": self.units, "lang": "en"}
    ...
    def _fetch_forecast(self, destination: str) -> dict[str, Any] | None:
    ...
    def _build_summary(self, weather_data: dict[str, Any], start: datetime, end: datetime, days_until_trip: int) -> str:
