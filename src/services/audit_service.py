...
class AuditLogger:
    ...
    @classmethod
    def log_login_success(cls, user_id: str, username: str, remember: bool = False) -> AuditLog | None:
    ...
    @classmethod
    def log_login_failed(cls, username: str, reason: str = "Invalid credentials") -> AuditLog | None:
    ...
    @classmethod
    def log_logout(cls, user_id: str, username: str) -> AuditLog | None:
        """Log user logout"""
        return cls.log(
    ...
    @classmethod
    def log_register(cls, user_id: str, username: str, email: str) -> AuditLog | None:
    ...
    @classmethod
    def log_trip_create(cls, trip_id: str, destination: str, user_id: str, username: str) -> AuditLog | None:
        """Log trip creation"""
        return cls.log(
    ...
    @classmethod
    def log_trip_update(
        cls, trip_id: str, user_id: str, username: str, changes: dict[str, Any] | None = None
    ) -> AuditLog | None:
        """Log trip update"""
        return cls.log(
    ...
    @classmethod
    def log_trip_delete(cls, trip_id: str, destination: str, user_id: str, username: str) -> AuditLog | None:
        """Log trip deletion"""
        return cls.log(
    ...
    @classmethod
    def log_pdf_export(cls, trip_id: str, destination: str, user_id: str, username: str) -> AuditLog | None:
        """Log PDF export"""
        return cls.log(
    ...
    @classmethod
    def log_permission_denied(cls, resource_type: str, resource_id: str, action: str) -> AuditLog | None:
    ...
    def log_security_event(
        cls, event_type: str, action: str, severity: str = SEVERITY_WARNING, metadata: dict[str, Any] | None = None
    ) -> AuditLog | None:
    ...
    def query_failed_logins(cls, hours: int = 24, limit: int = 100):
        ...
        return (
            db_session.query(AuditLog)
            .filter(AuditLog.event_type == cls.EVENT_LOGIN_FAILED, AuditLog.timestamp >= cutoff_time)
            .order_by(AuditLog.timestamp.desc())
            .limit(limit)
            .all()
        )
    ...
    def query_security_events(cls, hours: int = 24, limit: int = 100):
        ...
        return (
            db_session.query(AuditLog)
            .filter(AuditLog.event_category == cls.CATEGORY_SECURITY, AuditLog.timestamp >= cutoff_time)
            .order_by(AuditLog.timestamp.desc())
            .limit(limit)
            .all()
        )
