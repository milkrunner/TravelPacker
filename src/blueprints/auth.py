...
def google_signin():
    ...
    from src.utils.security_utils import get_ip_address, security_monitor, track_authentication_attempt
    ...
    if security_monitor.is_ip_suspicious(ip_address):
        return jsonify({"success": False, "error": "Too many failed login attempts. Please try again later."}), 429
    ...
    try:
        ...
        try:
            ...
            AuditLogger.log_security_event(event_type="login_success", action="google_oauth_login", severity="info")
        ...
        try:
            ...
            AuditLogger.log_security_event(event_type="login_error", action="google_oauth_error", severity="warning")
        except (ImportError, AttributeError):
