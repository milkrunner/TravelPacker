...
def csp_report():
    ...
    try:
        ...
        sanitize_for_log(violation.get("blocked-uri", "unknown"))
        sanitize_for_log(violation.get("violated-directive", "unknown"))
        sanitize_for_log(violation.get("document-uri", "unknown"))
