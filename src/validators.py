...
class TripCreateRequest(BaseModel):
    ...
    def validate_date(cls, v):
        ...
        try:
            ...
            raise ValueError(f"Invalid date format. Expected YYYY-MM-DD, got: {v}") from err
    ...
    def validate_travel_style(cls, v):
        ...
        valid_styles = {"Business", "Leisure", "Adventure", "Backpacking", "Luxury", "Budget", "Family", "Solo"}
    ...
    def validate_transport_method(cls, v):
        ...
        valid_methods = {"Flight", "Car", "Train", "Bus", "Cruise", "Other"}
