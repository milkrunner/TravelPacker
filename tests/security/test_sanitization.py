...
class TestTripDataSanitization:
    ...
    def test_sanitize_destination(self):
        ...
        data = {"destination": "<script>alert(1)</script>Paris", "start_date": "2024-01-01", "end_date": "2024-01-07"}
    ...
    def test_sanitize_special_notes_removes_scripts(self):
        ...
        data = {"destination": "Paris", "special_notes": "Note <script>alert(1)</script> here"}
        result = ContentSanitizer.sanitize_trip_data(data)
    ...
    def test_sanitize_travelers_list(self):
        ...
        data = {"destination": "Paris", "travelers": ["<b>John</b>", "<script>alert(1)</script>Jane", "Bob"]}
        result = ContentSanitizer.sanitize_trip_data(data)
        # Tags removed but text content remains
    ...
    def test_sanitize_activities_list(self):
        ...
        data = {"destination": "Paris", "activities": ["<b>Sightseeing</b>", "<script>alert(1)</script>Dining"]}
        result = ContentSanitizer.sanitize_trip_data(data)
    ...
    def test_sanitize_template_name(self):
        ...
        data = {"destination": "Paris", "template_name": "<b>Summer</b> <script>alert(1)</script>Trip"}
        result = ContentSanitizer.sanitize_trip_data(data)
...
class TestItemDataSanitization:
    ...
    def test_sanitize_item_name(self):
        ...
        data = {"name": "<script>alert(1)</script>Passport", "category": "documents"}
    ...
    def test_sanitize_item_notes(self):
        ...
        data = {"name": "Passport", "notes": '<b>Keep safe!</b> <a href="https://embassy.com">Embassy link</a>'}
        result = ContentSanitizer.sanitize_item_data(data)
    ...
    def test_sanitize_item_notes_removes_scripts(self):
        ...
        data = {"name": "Passport", "notes": "Note <script>alert(1)</script> here"}
        result = ContentSanitizer.sanitize_item_data(data)
        assert "<script>" not in result["notes"]

    def test_passthrough_item_fields(self):
        """Test non-text item fields pass through"""
        data = {"name": "Passport", "category": "documents", "quantity": 1, "is_packed": False, "is_essential": True}
        result = ContentSanitizer.sanitize_item_data(data)
