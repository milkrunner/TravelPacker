...
class TestAuditLogCreation:
    ...
    def test_audit_log_with_metadata(self, cleanup_audit_logs):
        ...
        log = AuditLogger.log(event_type=AuditLogger.EVENT_TRIP_CREATE, action="Created trip", metadata=metadata)
    ...
    def test_audit_log_with_changes(self, cleanup_audit_logs):
        ...
        log = AuditLogger.log(event_type=AuditLogger.EVENT_TRIP_UPDATE, action="Updated trip status", changes=changes)
...
class TestAuthenticationAuditLogs:
    ...
    def test_log_login_success(self, cleanup_audit_logs):
        ...
        log = AuditLogger.log_login_success(user_id="user_123", username="testuser", remember=True)
    ...
    def test_log_login_failed(self, cleanup_audit_logs):
        ...
        log = AuditLogger.log_login_failed(username="testuser", reason="Invalid password")
    ...
    def test_log_logout(self, cleanup_audit_logs):
        """Test logging logout"""
        log = AuditLogger.log_logout(user_id="user_123", username="testuser")
    ...
    def test_log_register(self, cleanup_audit_logs):
        ...
        log = AuditLogger.log_register(user_id="user_123", username="newuser", email="newuser@example.com")
...
class TestDataModificationAuditLogs:
    ...
    def test_log_trip_create(self, cleanup_audit_logs):
        ...
        log = AuditLogger.log_trip_create(
            trip_id="trip_123", destination="Paris", user_id="user_123", username="testuser"
        )
    ...
    def test_log_trip_update(self, cleanup_audit_logs):
        ...
        changes = {"before": {"destination": "Paris"}, "after": {"destination": "London"}}
        log = AuditLogger.log_trip_update(trip_id="trip_123", user_id="user_123", username="testuser", changes=changes)
...
class TestSecurityEventLogging:
    ...
    def test_log_permission_denied(self, cleanup_audit_logs):
        ...
        log = AuditLogger.log_permission_denied(resource_type="trip", resource_id="trip_123", action="delete")
...
class TestAuditLogQueries:
    ...
    def test_query_failed_logins(self, cleanup_audit_logs):
        ...
        for i in range(3):
            AuditLogger.log_login_failed(username=f"user{i}", reason="Invalid password")

        # Create successful login
        AuditLogger.log_login_success(user_id="user_123", username="testuser")
    ...
    def test_query_resource_history(self, cleanup_audit_logs):
        ...
        for event_type in [AuditLogger.EVENT_TRIP_CREATE, AuditLogger.EVENT_TRIP_UPDATE]:
            AuditLogger.log(
                event_type=event_type, action=f"{event_type} on trip", resource_type="trip", resource_id="trip_123"
            )
...
class TestAuditLogToDict:
    ...
    def test_to_dict(self, cleanup_audit_logs):
        ...
        log = AuditLogger.log_login_success(user_id="user_123", username="testuser")
...
class TestAuditLogErrorHandling:
    ...
    def test_audit_log_doesnt_break_on_error(self):
        ...
        AuditLogger.log(event_type="test_event", action="Test action")
