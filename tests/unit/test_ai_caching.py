...
class TestAICachingStrategy:
    ...
    def test_cache_key_differs_for_different_destinations(self):
        ...
        trip_paris = Trip(destination="Paris", start_date="2025-06-15", end_date="2025-06-22", travelers=["Alice"])

        trip_london = Trip(destination="London", start_date="2025-06-15", end_date="2025-06-22", travelers=["Alice"])
    ...
    def test_cache_key_differs_for_different_dates(self):
        ...
        trip_summer = Trip(destination="Paris", start_date="2025-06-15", end_date="2025-06-22", travelers=["Alice"])

        trip_winter = Trip(destination="Paris", start_date="2025-12-15", end_date="2025-12-22", travelers=["Alice"])
    ...
    def test_cache_key_differs_for_different_travelers(self):
        ...
        trip_solo = Trip(destination="Paris", start_date="2025-06-15", end_date="2025-06-22", travelers=["Alice"])

        trip_couple = Trip(
            destination="Paris", start_date="2025-06-15", end_date="2025-06-22", travelers=["Alice", "Bob"]
        )
    ...
    def test_cache_key_same_for_reordered_travelers(self):
        ...
        trip_1 = Trip(
            destination="Paris", start_date="2025-06-15", end_date="2025-06-22", travelers=["Bob", "Alice", "Charlie"]
        )

        trip_2 = Trip(
            destination="Paris", start_date="2025-06-15", end_date="2025-06-22", travelers=["Alice", "Bob", "Charlie"]
        )
...
class TestCacheInvalidation:
    ...
    def test_cache_invalidated_on_trip_update(self, mock_get_cache):
        ...
        trip = trip_service.create_trip(
            destination="Paris", start_date="2025-06-15", end_date="2025-06-22", travelers=["Alice"]
        )
    ...
    def test_cache_miss_generates_new_suggestions(self):
        ...
        with (
            ...
            trip = Trip(
                id="trip_123", destination="Paris", start_date="2025-06-15", end_date="2025-06-22", travelers=["Alice"]
            )
...
class TestCachePerformance:
    ...
    def test_different_trips_produce_different_cache_keys(self):
        ...
        trip_data_1 = {"destination": "Paris", "start_date": "2025-06-15", "duration": 8, "travelers": ["Alice"]}

        trip_data_2 = {"destination": "London", "start_date": "2025-06-15", "duration": 8, "travelers": ["Alice"]}
